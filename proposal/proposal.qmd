...
<!--JN: as I mentioned before -- I would add that explanation earlier-->
...
<!-- JN: I do not understand the code example below: you have a path to the raster, but you do not use it... -->
