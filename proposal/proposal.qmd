...
![Terrain aspect, estimated using the `wbw` package and plotted with `terra`](https://github.com/atsyplenkov/wbw/blob/main/man/figures/README-terra-1.png?raw=true){#fig-aspect width=60%}
