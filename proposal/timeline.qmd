...
We propose a start date of 1st of May 2025 and outline three work packages for successful development of the software proposed here, as follows (see @fig-gannt). 

**WP1: Core System Design**  
In WP1, we will redesign the Python dependency with `uv` support using the updated `reticulate` v1.41. Additionally, we will update the testing framework to include unit tests, snapshot tests, and property-based testing. Currently, testing in the `wbw` package is implemented using the `tinytest` package, but additional dependencies such as `quicktest` and `mockery` will be introduced. There is also a possibility of fully transitioning to the `testthat` infrastructure, if needed. Furthermore, we plan to add support for `WhiteboxVector` and `WhiteboxLidar` objects, which will later be used for GIS tools and LiDAR processing. The first project milestone (**M1**) will focus on establishing the framework and preparing the package for function implementation.

**WP2: Package Functionality**  
Once the core system is in place, we will begin implementing functions. Every function from _'Whitebox Workflows for Python'_ will be ported to the `wbw` package as an `S7` generic method. This work package primarily involves routine function implementation, as most functions follow a similar structure. Once the majority of functions have been ported, tested, and documented—including vignettes and tutorials—the `wbw` package will be submitted for [ROpenSci Software Peer Review](https://ropensci.org/software-review/) (**M2**). ROpenSci recommends submitting a package at a mature stage, where most functionality is implemented but still allows for refinements. We acknwoledge that review process may lead to significant modifications. The third milestone (**M3**) will be the initial ROpenSci feedback, which could result in major improvements, including function renaming and breaking changes, therefore we are booking a buffer time for this.
...
wbw_project <- tibble::tribble(
  ...
  "WP1", "1.1. Dependency management",              "2025-05-01", "2025-05-07",
  "WP1", "1.2. Testing infrastructure",             "2025-05-07", "2025-05-15",
  "WP1", "1.3. WhiteboxVector support",             "2025-05-16", "2025-05-20",
  "WP1", "1.4. LiDAR objects support",              "2025-05-20", "2025-05-25",
  "WP2", "2.1. Geomorphometry and Hydrology tools", "2025-06-01", "2025-06-06",
  "WP2", "2.2. GIS and Math tools",                 "2025-06-08", "2025-06-15",
  "WP2", "2.3. Image processing tools",             "2025-06-20", "2025-06-25",
  "WP2", "2.4. LiDAR processing tools",             "2025-05-20", "2025-07-07",
  "WP2", "2.5. WbW Pro tools",                      "2025-07-10", "2025-07-25",
  "WP3", "3.1. Vignette writing",                   "2025-06-01", "2025-10-01",
  "WP3", "3.2. ROpenSci software review",           "2025-08-01", "2025-10-01",
  "WP3", "3.3. CRAN submission",                    "2025-10-01", "2025-10-15",
